...
Config.Shops = {
    gc = { -- City location
        managed = true,
        shopLabel = 'Gator Customs',
        showBlip = true,
        blipSprite = 72,
        blipColor = 46,
        blipCoords = vector3(-346.02, -130.68, 39.02),
        duty = vector3(-322.93, -146.57, 39.02),
        stash = vector3(-316.8, -129.89, 39.02),
        paint = vector3(-322.26, -96.09, 39.02),
        vehicles = {
            withdraw = vector3(-369.49, -103.7, 38.78),
            spawn = vector4(-357.62, -87.48, 45.57, 71.78),
