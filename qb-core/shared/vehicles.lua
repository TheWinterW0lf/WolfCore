...
local Vehicles = {
    ...
    { model = 'vigero',          name = 'Vigero',                        brand = 'Declasse',        price = 39500,   category = 'muscle',         type = 'automobile', shop = 'austin', },
    ...
    { model = 'formula',         name = 'PR4',                           brand = 'Progen',          price = 100000,  category = 'openwheel',      type = 'automobile', shop = 'none' },
     ...
     --- Addon Cars
    {
        model = 'ikx3_boss20',        -- This has to match the spawn code of the vehicle
        name = 'SILV 20',         -- This is the display of the vehicle
        brand = 'CHEVY',     -- This is the vehicle's brand
        price = 165000,          -- The price that the vehicle sells for
        category = 'offroad', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm','austin',            -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = 'dragmaro',        -- This has to match the spawn code of the vehicle
        name = 'dragmaro (DEBUG)',         -- This is the display of the vehicle
        brand = '(DEBUG)',     -- This is the vehicle's brand
        price = 150000,          -- The price that the vehicle sells for
    ...
    {
        model = '95stang',        -- This has to match the spawn code of the vehicle
        name = '1995 Mustang ',         -- This is the display of the vehicle
        brand = 'Ford',     -- This is the vehicle's brand
        price = 105000,          -- The price that the vehicle sells for
        category = 'muscle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm','austin',            -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = 'n1gt13hy',        -- This has to match the spawn code of the vehicle
        name = 'Shelby GT500',         -- This is the display of the vehicle
        brand = 'Ford',     -- This is the vehicle's brand
    ...
    {
        model = 'manssupersnake',        -- This has to match the spawn code of the vehicle
        name = '2022 Mustang SuperSnake',         -- This is the display of the vehicle
        brand = 'Ford',     -- This is the vehicle's brand
        price = 115000,          -- The price that the vehicle sells for
        category = 'muscle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
    ...
    {
        model = 'rrflashwidebody',        -- This has to match the spawn code of the vehicle
        name = 'Widebody Ford Focus',         -- This is the display of the vehicle
        brand = 'Ford',     -- This is the vehicle's brand
        price = 115000,          -- The price that the vehicle sells for
        category = 'sports', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
    ...
    {
        model = 'rs72021',        -- This has to match the spawn code of the vehicle
        name = 'Audi RS7',         -- This is the display of the vehicle
        brand = 'Audi',     -- This is the vehicle's brand
    ...
    {
        model = 'rrhycadehuracan',        -- This has to match the spawn code of the vehicle
        name = 'Lamborghini Huracan',         -- This is the display of the vehicle
        brand = 'Lamdo',     -- This is the vehicle's brand
        price = 350000,          -- The price that the vehicle sells for
        category = 'super', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm','austin',            -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = '94streetgt',        -- This has to match the spawn code of the vehicle
        name = '1994 Drag Mustang',         -- This is the display of the vehicle
        brand = 'Mustang',     -- This is the vehicle's brand
    ...
    {
        model = 'rmodbolide',        -- This has to match the spawn code of the vehicle
        name = 'Bugatti Bolide',         -- This is the display of the vehicle
        brand = 'Bugatti',     -- This is the vehicle's brand
        price = 3500000,          -- The price that the vehicle sells for
        category = 'muscle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm', 'austin',          -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = 'srtchar',        -- This has to match the spawn code of the vehicle
        name = '2021 SRT Charger',         -- This is the display of the vehicle
        brand = 'Charger',     -- This is the vehicle's brand
        price = 210000,          -- The price that the vehicle sells for
        category = 'muscle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm','austin',            -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = 'berserk',        -- This has to match the spawn code of the vehicle
        name = 'Berserk harley',         -- This is the display of the vehicle
        brand = 'Harley',     -- This is the vehicle's brand
        price = 65000,          -- The price that the vehicle sells for
        category = 'motorcycle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm','austin',            -- Can be a single shop or multiple shops. For multiple shops for example {'shopname1','shopname2','shopname3'}
    },
    {
        model = 'born2',        -- This has to match the spawn code of the vehicle
        name = 'Born Harley',         -- This is the display of the vehicle
        brand = 'Harley',     -- This is the vehicle's brand
        price = 65000,          -- The price that the vehicle sells for
        category = 'motorcycle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
    ...
    {
        model = 'v4',        -- This has to match the spawn code of the vehicle
        name = 'Martin V4',         -- This is the display of the vehicle
        brand = 'Ducati',     -- This is the vehicle's brand
    ...
    {
        model = 'v4sl',        -- This has to match the spawn code of the vehicle
        name = 'Martin V4SL',         -- This is the display of the vehicle
        brand = 'Ducati',     -- This is the vehicle's brand
        price = 85000,          -- The price that the vehicle sells for
        category = 'motorcycle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
    ...
    {
        model = 'v4sp',        -- This has to match the spawn code of the vehicle
        name = 'Martin V4SP',         -- This is the display of the vehicle
        brand = 'Ducati',     -- This is the vehicle's brand
        price = 105000,          -- The price that the vehicle sells for
        category = 'motorcycle', -- Catgegory of the vehilce, stick with GetVehicleClass() options https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Vehicle type, refer here https://docs.fivem.net/natives/?_0x6AE51D4B & here https://docs.fivem.net/natives/?_0xA273060E
     ...
     {
        model = 'protoz',        -- This has to match the spawn code of the vehicle
        name = 'Nissian Pro',         -- This is the display of the vehicle
        brand = 'Nissian',     -- This is the vehicle's brand
