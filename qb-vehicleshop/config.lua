...
Config.Shops = {
    ...
    ['austin'] = {
        ...
        ['Zone'] = {
            ['Shape'] = {      --polygon that surrounds the shop
  				vector2(-315.71292114258, -1354.0715332032),
 				vector2(-314.75064086914, -1385.6802978516),
  				vector2(-342.09768676758, -1385.6094970704),
  				vector2(-340.47296142578, -1353.4750976562)
            },
            ['minZ'] = 31.870506286622,                                         -- min height of the shop zone
            ['maxZ'] = 45.00,                                         -- max height of the shop zone
            ['size'] = 7.75,                                          -- size of the vehicles zones
        },
        ['Job'] = 'none',                                            -- Name of job or none
        ['ShopLabel'] = 'Austin Dealership',                          -- Blip name
        ['showBlip'] = true,                                         -- true or false
        ['blipSprite'] = 326,                                        -- Blip sprite
        ['blipColor'] = 3,                                           -- Blip color
        ['TestDriveTimeLimit'] = 0.5,                                -- Time in minutes until the vehicle gets deleted
        ['Location'] = vector3(-313.02, -1369.95, 31.84),             -- Blip Location
        ['ReturnLocation'] = vector3(-313.72, -1348.54, 30.6),       -- Location to return vehicle, only enables if the vehicleshop has a job owned
        ['VehicleSpawn'] = vector4(-301.93, -1380.86, 30.59, 90.18), -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = vector4(-300.12, -1348.25, 30.6, 89.7), -- Spawn location for test drive
        ['FinanceZone'] = vector3(-337.96, -1372.2, 31.87),
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-326.53, -1370.02, 31.89, 270.08), -- where the vehicle will spawn on display
                defaultVehicle = 'rmodbolide',                       -- Default display vehicle
                chosenVehicle = 'rmodbolide'                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
                coords = vector4(-319.39, -1360.22, 31.27, 141.73), -- where the vehicle will spawn on display
                defaultVehicle = 'rs72021',                       -- Default display vehicle
                chosenVehicle = 'rs72021'                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [3] = {
                coords = vector4(-333.47, -1357.88, 31.27, 214.45), -- where the vehicle will spawn on display
                defaultVehicle = 'srtchar',                       -- Default display vehicle
                chosenVehicle = 'srtchar'                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [4] = {
                coords = vector4(-332.08, -1380.4, 31.27, 315.97), -- where the vehicle will spawn on display
                defaultVehicle = 'manssupersnake',                       -- Default display vehicle
                chosenVehicle = 'manssupersnake'                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [5] = {
                coords = vector4(-319.78, -1381.89, 31.27, 49.69), -- where the vehicle will spawn on display
                defaultVehicle = 'rrflashwidebody',                       -- Default display vehicle
                chosenVehicle = 'rrflashwidebody'                        -- Same as default but is dynamically changed when swapping vehicles
            },
